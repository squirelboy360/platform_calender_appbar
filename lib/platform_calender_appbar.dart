...
class PlatformCalendarAppBar extends StatefulWidget
  ...
  ///initialization of [PlatformCalendarAppBar]
  PlatformCalendarAppBar({
    Key? key,
  ...
  ///creating state
  PlatformCalendarAppBarState createState() => PlatformCalendarAppBarState();
...
class PlatformCalendarAppBarState extends State<PlatformCalendarAppBar> {
  ...
  void initState() {
    setState(() {
      ///initializing accent
      accent = widget.accent ?? Colors.black;
  ...
  Widget build(BuildContext context) {
    ...
    Widget calendarView() {
      //!This widget would be rendered for ios and android based of conditions yet to be met bekow
      Widget calender_app_bar_scroll() {
      ...
      return PlatformAppBar(
        cupertino: (context, platform) =>
            CupertinoNavigationBarData(title: calender_app_bar_scroll()),
      );
    }
